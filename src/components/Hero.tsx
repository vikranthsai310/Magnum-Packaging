          ...
          <div className="relative group">
            ...
            <div className="relative backdrop-blur-xl bg-gradient-to-br from-white/30 via-white/20 to-white/10 rounded-full px-6 md:px-8 py-3 md:py-4 shadow-[0_8px_32px_0_rgba(125,82,53,0.06),0_2px_8px_0_rgba(125,82,53,0.03)] border border-white/30 hover:shadow-[0_12px_48px_0_rgba(125,82,53,0.08),0_4px_12px_0_rgba(125,82,53,0.04)] transition-all duration-700">
              ...
              >
                <a
                  href="#"
                  className="relative px-4 py-2 rounded-full font-mono text-[10px] md:text-xs font-semibold uppercase tracking-wider text-foreground/90 hover:text-primary transition-all duration-500 group/item overflow-hidden"
                >
              ...
              <div className="hidden md:flex animate-fade-in flex-shrink-0" style={{ animationDelay: "200ms" }}>
                <div className="relative group/cta">
                  ...
                  <Button
                    ...
                    className="relative btn-3d font-mono text-[10px] md:text-xs uppercase tracking-wider shadow-[0_4px_16px_0_rgba(125,82,53,0.2)] hover:shadow-[0_6px_24px_0_rgba(125,82,53,0.3)] transition-all duration-700 px-5 md:px-6 py-2 md:py-2.5 rounded-full bg-gradient-to-br from-primary via-primary to-primary/90 hover:from-primary/95 hover:via-primary hover:to-primary text-white overflow-hidden"
                  >
                    {/* Top shine */}
